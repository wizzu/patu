...
public class Tapahtuma extends Tietue {
    ...
    public Tapahtuma( String line ) throws ParseException {
        ...
        tapahtumanRahamaara = Double.parseDouble( line.substring(87, 106) ) / 100.0D;
    ...
    public String getViitenumero() {
        for( Lisatietue t : lisatietueet ) {
            if( t.lisatiedonTyyppi == Lisatietue.VIITETIETO && t.numerodata != null ) {
                try {
                    return Long.toString( Long.parseLong( t.numerodata ) );
                } catch( NumberFormatException nfe ) {
                    return t.numerodata;
                }
            }
        }
        return Long.toString( viitenumero );
    }
